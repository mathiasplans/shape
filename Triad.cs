...
namespace Shape {
    public class Triad : IShape {
        ...
        private void InitializeVertices((float[] v1, float[] v2, float[] v3) vertices) {
            this.v1 = vertices.v1;
            this.v2 = vertices.v2;
            this.v3 = vertices.v3;
        }
        
        public Triad(Rules rules, (float[] v1, float[] v2, float[] v3) vertices) {
        ...
        public Triad(Rules rules, Attributes attributes, (float[] v1, float[] v2, float[] v3) vertices) {
            this.InitializeVertices(vertices);
            this.rules = rules;
            this.rnd = new Random();
        ...
        public List<float[]> GetVertices() {
            return new List<float[]> {this.v1, this.v2, this.v3};
        }
    }
}